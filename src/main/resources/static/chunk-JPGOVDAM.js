import{Fa as q,Ga as g,Ja as A,Ma as P,j as Q,l as E,n as N,s as O}from"./chunk-HT6JNWVA.js";import{Ab as I,Gb as u,Gc as B,Hb as d,Ib as x,Jb as M,Kb as w,Sb as l,Tb as D,Ub as F,Vb as f,W as v,Wa as o,X as h,Xb as m,Yb as y,aa as T,ac as j,bc as S,gb as b,hb as C,hc as z,kb as $,la as p,mb as r,wb as i,zb as k}from"./chunk-SQFFUPMZ.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
